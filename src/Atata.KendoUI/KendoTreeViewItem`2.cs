    ...
    where TOwner : PageObject<TOwner>
{
    ...
    protected virtual bool GetIsSelected() =>
        Text.DomClasses.Value.Intersect([KendoClass.Selected, KendoClass.StateSelected]).Any();

    protected override bool GetIsFocused() =>
        Text.DomClasses.Value.Intersect([KendoClass.Focus, KendoClass.StateFocused]).Any();

    protected override bool GetIsEnabled() =>
        !Text.DomClasses.Value.Intersect([KendoClass.Disabled, KendoClass.StateDisabled]).Any();
